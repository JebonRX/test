...
state="Kelantan"               # State / Province
locality="Kota Bharu"          # City / Locality
organization="NevermoreSSH Sdn Bhd"
organizationalunit="IT Department"
commonname="nevermoressh"         # Common Name (domain / server)
email="elliez667@gmail.com"    # Admin Email

# simple password minimal
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/JebonRX/test/main/others/password"
...
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/JebonRX/test/main/ssh/badvpn-udpgw64"
...
# install lolcat
wget https://raw.githubusercontent.com/JebonRX/test/main/others/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
